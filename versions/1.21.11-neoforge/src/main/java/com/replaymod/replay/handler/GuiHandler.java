...
public class GuiHandler extends EventRegistrations {
    ...
    private void injectIntoMainMenu(Screen guiScreen, Collection<ClickableWidget> buttonList) {
        ...
        if (mod.getCore().getSettingsRegistry().get(Setting.LEGACY_MAIN_MENU_BUTTON)) {
            ...
            properInjectIntoMainMenu(guiScreen, buttonList instanceof List ? (List<ClickableWidget>) buttonList : new ArrayList<>(buttonList));
        }
        //#else
        //$$ legacyInjectIntoMainMenu(guiScreen, buttonList);
        //#endif
    ...
    //#if MC>=11604
    private void properInjectIntoMainMenu(Screen screen, List<ClickableWidget> buttonList) {
