...
preprocess {
    ...
    val mc26_01_00neoforge = createNode("26.1-neoforge", 26_01_00, "yarn")
    ...
    val mc12110neoforge = createNode("1.21.10-neoforge", 12110, "yarn")
    val mc12108neoforge = createNode("1.21.8-neoforge", 12108, "yarn")
    val mc12107 = createNode("1.21.7", 12107, "yarn")
    val mc12105 = createNode("1.21.5", 12105, "yarn")
    val mc12105neoforge = createNode("1.21.5-neoforge", 12105, "yarn")
    val mc12104 = createNode("1.21.4", 12104, "yarn")
    val mc12104neoforge = createNode("1.21.4-neoforge", 12104, "yarn")
    val mc12103neoforge = createNode("1.21.3-neoforge", 12103, "yarn")
    val mc12102 = createNode("1.21.2", 12102, "yarn")
    val mc12100 = createNode("1.21", 12100, "yarn")
    val mc12100neoforge = createNode("1.21-neoforge", 12100, "yarn")
    val mc12006 = createNode("1.20.6", 12006, "yarn")
    val mc12006neoforge = createNode("1.20.6-neoforge", 12006, "yarn")
    val mc12004 = createNode("1.20.4", 12004, "yarn")
    val mc12004neoforge = createNode("1.20.4-neoforge", 12004, "yarn")
    val mc12002 = createNode("1.20.2", 12002, "yarn")
    val mc12002neoforge = createNode("1.20.2-neoforge", 12002, "yarn")
    ...
    mc12111neoforge.link(mc26_01_00neoforge, file("versions/mapping-neoforge-26.1-neoforge-1.21.11-neoforge.txt"))
    mc12111.link(mc12110, file("versions/mapping-fabric-1.21.11-1.21.10.txt"))
    mc12110.link(mc12110neoforge, file("versions/mapping-neoforge-1.21.10-neoforge-1.21.10.txt"))
    mc12110.link(mc12107, file("versions/mapping-fabric-1.21.10-1.21.7.txt"))
    mc12107.link(mc12108neoforge, file("versions/mapping-neoforge-1.21.8-neoforge-1.21.8.txt"))
    mc12107.link(mc12105)
    mc12105.link(mc12105neoforge, file("versions/mapping-neoforge-1.21.5-neoforge-1.21.5.txt"))
    mc12105.link(mc12104, file("versions/mapping-fabric-1.21.5-1.21.4.txt"))
    mc12104.link(mc12104neoforge, file("versions/mapping-neoforge-1.21.4-neoforge-1.21.4.txt"))
    mc12104.link(mc12103neoforge, file("versions/mapping-neoforge-1.21.3-neoforge-1.21.3.txt"))
    mc12104.link(mc12102)
    mc12102.link(mc12100)
    mc12100.link(mc12100neoforge, file("versions/mapping-neoforge-1.21-neoforge-1.21.txt"))
    mc12100.link(mc12006)
    mc12006.link(mc12006neoforge, file("versions/mapping-neoforge-1.20.6-neoforge-1.20.6.txt"))
    mc12006.link(mc12004)
    mc12004.link(mc12004neoforge, file("versions/mapping-neoforge-1.20.4-neoforge-1.20.4.txt"))
    mc12004.link(mc12002, file("versions/mapping-fabric-1.20.4-1.20.2.txt"))
    mc12002.link(mc12002neoforge, file("versions/mapping-neoforge-1.20.2-neoforge-1.20.2.txt"))
